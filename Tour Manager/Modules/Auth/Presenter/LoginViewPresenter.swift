...
protocol LoginPresenterProtocol:AnyObject{
    ...
    func getUserInfoFromApi(completion: @escaping (Bool)->Void)
    
    func sendVerifyEmail(email:String, password:String, completion: @escaping (Bool)->Void)
}
...
class LoginPresenter:LoginPresenterProtocol{
    ...
    func resetPassword(email:String){
        view?.setLoadingView()
        Task{
            let result = try await authNetworkService.resetPassword(email: email)
...
//        }
    ...
    public func getUserInfoFromApi(completion: @escaping (Bool)->Void){
...
//        }
    ...
    public func sendVerifyEmail(email:String, password:String, completion: @escaping (Bool)->Void){
